...
class PipSession(requests.Session):
    ...
    def is_secure_origin(self, location: Link) -> bool:
        ...
        # Don't count the repositories type as part of the protocol: in
        ...
        logger.warning(
            "The repositories located at %s is not a trusted or secure host and "
            "is being ignored. If this repositories is available via HTTPS we "
