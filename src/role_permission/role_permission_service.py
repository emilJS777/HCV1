...
def bind_role_permission(role_id, permission_id):
    ...
    for roleId in user_role_service_db.get_role_ids_by_user_id(user_id=g.user_id):
        for permissionId in role_permission_service_db.get_permission_ids_by_role_id(role_id=roleId):
            ...
            if permissionId == permission_id:
                ...
                if role_permission_service_db.get_by_role_id_permission_id(role_id, permission_id):
