from src.services_db import user_service_db, user_role_service_db, role_service_db
...
def get_role_ids_by_user_id(user_id):
    ...
    role_ids = user_role_service_db.get_role_ids_by_user_id(user_id=user_id)
...
def bind_user_role(user_id, role_id):
    ...
    if user_role_service_db.get_by_user_id_role_id(user_id=user_id, role_id=role_id):
