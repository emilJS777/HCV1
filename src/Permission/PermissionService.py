...
def permission_get_all(user_id):
    # GET AND RETURN ALL PERMISSION IDS BY USER ID
    permissions = []
    # for permission_id in user_permission_service_db.get_permission_ids_by_user_id(user_id=user_id):
    #     permission = PermissionServiceDb.get_by_id(permission_id=permission_id)
